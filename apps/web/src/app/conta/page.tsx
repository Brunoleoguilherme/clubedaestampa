  ...
  return (
    <div className="space-y-4">
      ...
      {staff && (
        <Link
          href="/admin"
          className="inline-block rounded-lg bg-brand-500 px-4 py-2 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-brand-400"
        >
